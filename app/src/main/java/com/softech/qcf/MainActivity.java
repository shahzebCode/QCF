...
public class MainActivity extends AppCompatActivity {
    ...
    protected Button btnSendData, btnScanQR, btnGenerateQR, btnCancelQR;
    ...
    private void initViews() {
        ...
        btnCancelQR = findViewById(R.id.btn_cancel_qr);
    }
}